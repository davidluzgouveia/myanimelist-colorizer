...
(function() {
  ...
  function getColor(text) {
    if (
      ...
      return "#ddf5dd";
    else if (text.includes("Completed") || text.includes("CMPL"))
      return "#d5e1ef";
    else if (text.includes("On-Hold") || text.includes("HOLD"))
      return "#fafadf";
    else if (text.includes("Dropped") || text.includes("DROP"))
      return "#ffd5d5";
    else if (
      text.includes("Plan to Watch") ||
      text.includes("PTW") ||
      text.includes("Plan to Read") ||
      text.includes("PTR")
    )
      return "#e9e9e9";
    else return "#ffffff";
